...
public class KGsCleaning {
    ...
    static class cleanTool{
        ...
        public KG grammarRegularize(KG kg){return new KG();}

        public KG spellingCorrect(KG kg){return new KG();}

        public KG fullSimpleConvert(KG kg){return new KG();}

        public KG stopWordsDelete(KG kg){return new KG();}
